...
mkdir release\arm
for /f %%f in ('dir /b %EDK2_BUILD%\ARM\*.efi') do copy %EDK2_BUILD%\ARM\%%f release\arm\%%~nf_arm%%~xf

mkdir release\ia32
for /f %%f in ('dir /b %EDK2_BUILD%\IA32\*.efi') do copy %EDK2_BUILD%\IA32\%%f release\ia32\%%~nf_ia32%%~xf
